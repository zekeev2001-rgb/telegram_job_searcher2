...
/* =========================================================
   МОБИЛЬНЫЙ БАННЕР
   На телефоне показывается временно и затем исчезает.
   ========================================================= */
...
/* Near Gig mobile hero / map controls */
(function injectNearGigMobileStyles() {
  if (document.getElementById('near-gig-mobile-fix')) return;

  const style = document.createElement('style');
  style.id = 'near-gig-mobile-fix';
  style.textContent = `
    @media (max-width: 650px) {
      ...
      .hero-card.mobile-hero-visible {
        opacity: 1 !important;
        transform: translateY(0) !important;
        pointer-events: auto !important;
      }

      .hero-card.mobile-hero-hidden {
        opacity: 0 !important;
